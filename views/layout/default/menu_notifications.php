...
<div class="content-wrapper">
    ...
    <div class="content">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: #3c4252!important; border-radius: 0px !important;">
            <i class="logo-icon <?php echo $this->icon_title;?> mr-2" style="color: #fff;"></i>
